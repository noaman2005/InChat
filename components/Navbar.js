...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 flex flex-col items-center w-20 h-screen bg-white border-r border-gray-300 shadow-lg z-50">
      {/* Rotating Icon */}
      <div className="mt-8 mb-10 cursor-pointer flex items-center animate-spin-slow" onClick={change12}>
        <svg
      ...
      {/* Sign Out Button */}
      <button onClick={handleSignOut} className="mt-auto mb-4 flex items-center justify-center w-12 h-12 rounded-full bg-red-500 hover:bg-red-600 transition duration-200">
